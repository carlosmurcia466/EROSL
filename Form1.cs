...
namespace EURO_CAPTURA
{
    public partial class Form1 : Form
    {
        ...
        string obseravacion1, observacion2;
        //CAMPOS NUEVOS
        string SUMA_UNID_BONI, SUMA_UNID_FACTURA, SUMA_UNID_VENDIDAS;

        string originales = @"C:\Facturacion Electronica\BK ORIGINALES\" + DateTime.Now.Year + @"\" + DateTime.Now.Month + @"\" + DateTime.Now.Day + @"\";
        ...
        public void Data()
        {
            originales = @"C:\Facturacion Electronica\BK ORIGINALES\" + DateTime.Now.Year + @"\" + DateTime.Now.Month + @"\" + DateTime.Now.Day + @"\";
            ...
            try
            {
                string queryDocumentos = "SELECT  OBSERVACION1,OBSERVACION2,NUMERO_FACTURA,NOMBRE_ESTABLECIMIENTO,CODIGO_SUCURSAL_CLIENTE,DIRECCION_CLIENTE,NOTAS,CODIGO_GENERACIONDTE,NUMERO_CONTROLDTE,FACTURA_ID_ABONONC,VENDEDOR,CREDITO_CONTADO,DIAS_CREDITO,FACTURA_ID,NUMERO_FACTURA,REGISTRO_FISCAL,COD_EMPRE,FECHA_EMISION,FECHA_REAL_CREACION,TIPO_DOCUMENTO,NUME_DOCUMENTO,ESTA_IMPRESA,SUMA_UNID_BONI, SUMA_UNID_FACTURA, SUMA_UNID_VENDIDAS from FACTURAS where ESTA_IMPRESA is null and  TOTAL_FACTURA !='0.00' and TIPO_DOCUMENTO IN ('1','2','3','4','6') and FECHA_EMISION >='2026-07-07'";
                ...
                using (SqlDataReader reader = cmdDocumentos.ExecuteReader())
                {
                    if (reader.Read())
                    {
                        ...
                        obseravacion1 = Convert.ToString(reader["OBSERVACION1"]);
                        observacion2 = Convert.ToString(reader["OBSERVACION2"]);
                        ...
                        SUMA_UNID_BONI = Convert.ToString(reader["SUMA_UNID_BONI"]);
                        SUMA_UNID_FACTURA = Convert.ToString(reader["SUMA_UNID_FACTURA"]);
                        SUMA_UNID_VENDIDAS = Convert.ToString(reader["SUMA_UNID_VENDIDAS"]);
            ...
            if (FACTURA_ID != null && FACTURA_ID!="")
            {
                ...
                {
                    string queryDocRelacionados = "SELECT OBSERVACION1,OBSERVACION2,CODIGO_GENERACIONDTE,NUMERO_FACTURA,SERIE_AUTORIZADA,FACTURA_ID_ABONONC,FECHA_REAL_CREACION,TIPO_DOCUMENTO from FACTURAS where FACTURA_ID='" + FACTURA_ID_ABONONC + "'";
                    ...
                    using (SqlDataReader reader = cmdRelacionado.ExecuteReader())
                    {
                        if (reader.Read())
                        {
                          ...
                          string  SERIE_AUTORIZADA = Convert.ToString(reader["SERIE_AUTORIZADA"]).ToString().Trim();
                           // obseravacion1 = Convert.ToString(reader["OBSERVACION1"]).ToString().Trim();
                           // observacion2 = Convert.ToString(reader["OBSERVACION2"]).ToString().Trim();
                ...
                using (SqlDataReader reader = cmdFacturas.ExecuteReader())
                {
                    if (reader.Read())
                    {
                     ...
                     //   NOMBRE_COMERCIAL_RECEPTOR = Convert.ToString(reader["NOMBRE_ESTABLECIMIENTO"]);
                        EMAIL_RECEPTOR = Convert.ToString(reader["EMAIL"].ToString().Trim());
                ...
                if (TIPO_DOCUMENTO == "2")
                {
                    ...
                    else
                    {
                        ...
                        iden.numeroControl = "DTE-03-" + "M001P001" + "-" + Convert.ToString(NUMERO_FACTURA).PadLeft(15, '0');
                        numeroControl = "DTE-03-" + "M001P001" + "-" + Convert.ToString(NUMERO_FACTURA).PadLeft(15, '0');
                ...
                else if (TIPO_DOCUMENTO == "1")
                {
                    ...
                    else
                    {
                        ...
                        iden.numeroControl = "DTE-01-" + "M001P001" + "-" + Convert.ToString(NUMERO_FACTURA).PadLeft(15, '0');
                        numeroControl = "DTE-01-" + "M001P001" + "-" + Convert.ToString(NUMERO_FACTURA).PadLeft(15, '0');
                ...
                else if (TIPO_DOCUMENTO=="3" && Convert.ToInt32(FACTURA_ID_ABONONC) > 0)
                {
                    ...
                    else
                    {
                        ...
                        iden.numeroControl = "DTE-05-" + "M001P001" + "-" + Convert.ToString(NUMERO_FACTURA).PadLeft(15, '0');
                        numeroControl = "DTE-05-" + "M001P001" + "-" + Convert.ToString(NUMERO_FACTURA).PadLeft(15, '0');
                ...
                else if (TIPO_DOCUMENTO == "4" && Convert.ToInt32(FACTURA_ID_ABONONC) > 0)
                {
                    ...
                    else
                    {
                        ...
                        iden.numeroControl = "DTE-06-" + "M001P001" + "-" + Convert.ToString(NUMERO_FACTURA).PadLeft(15, '0');
                        numeroControl = "DTE-06-" + "M001P001" + "-" + Convert.ToString(NUMERO_FACTURA).PadLeft(15, '0');
                ...
                else if (TIPO_DOCUMENTO == "6")
                {
                    ...
                    else
                    {
                        ...
                        iden.numeroControl = "DTE-11-" + "M001P001" + "-" + Convert.ToString(NUMERO_FACTURA).PadLeft(15, '0');
                        numeroControl = "DTE-11-" + "M001P001" + "-" + Convert.ToString(NUMERO_FACTURA).PadLeft(15, '0');
                ...
                if (TIPO_DOCUMENTO == "1")
                {
                    ...
                    {
                        rec.correo = EMAIL_RECEPTOR.ToString().Trim();
                    }
                ...
                if (TIPO_DOCUMENTO == "1")
                {
                   ...
                   // apend.Add(addApendice("1MPR1M3", "3 copias", "S"));
                    ...
                    if (SUMA_UNID_FACTURA.ToString().Trim() != "")
                    {
                        apend.Add(addApendice("UNIDADESFACTURADAS", "UNIDADES FACTURADAS", SUMA_UNID_FACTURA));

                    }
                    if (SUMA_UNID_BONI.ToString().Trim() != "")
                    {
                        apend.Add(addApendice("UNIDADESBONIFICADAS", "UNIDADES BONIFICADAS", SUMA_UNID_BONI));

                    }
                    if (SUMA_UNID_VENDIDAS.ToString().Trim() != "")
                    {
                        apend.Add(addApendice("UNIDADES TOTALES", "UNIDADES TOTALES", SUMA_UNID_VENDIDAS));

                    }

                    if (!string.IsNullOrWhiteSpace(obseravacion1))
                    {
                        apend.Add(addApendice(
                            "clientepedido_num",
                            "clientepedido_num",
                            obseravacion1
                        ));
                    ...
                    if (!string.IsNullOrWhiteSpace(observacion2))
                    {
                        apend.Add(addApendice(
                            "clientedevolucion_num",
                            "clientedevolucion_num",
                            observacion2
                        ));
                    }
                ...
                if (TIPO_DOCUMENTO == "1")
                {
                    ...
                    if (!(Directory.Exists(originales)))
                    {
                        Directory.CreateDirectory(originales);
                    }

                   
                    System.IO.File.WriteAllText(originales + numeroControl+"_"+codigoGeneracion + ".json", json_completo.Trim());
                ...
                SUMA_UNID_BONI = ""; SUMA_UNID_FACTURA = ""; SUMA_UNID_VENDIDAS = "";
